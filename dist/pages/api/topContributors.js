...
count // Default number of contributors to return
) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    authors = (_a.sent()).map(function (author) { return __awaiter(void 0, void 0, void 0, function () {
                        var authorInfo;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, prisma_1.default.author.findUnique({
                                        where: {
                                            slug: author.slug,
                                        },
                                        select: {
                    ...
                    return [2 /*return*/, Promise.all(authors)];
                case 2:
                    error_1 = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getTopContributors(startDate, endDate)];
                case 1:
                ...
                case 2:
                    ...
                    return [4 /*yield*/, getTopContributors(dateObj, dateObj)];
                case 3:
                    contributors = _a.sent();
                    res.json(contributors);
                    _a.label = 4;
